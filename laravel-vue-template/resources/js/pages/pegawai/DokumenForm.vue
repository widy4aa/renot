...
useFaq([
    { q: 'Format file yang diterima?', a: 'File sertifikat bisa berupa gambar (JPG, PNG, WebP) atau dokumen PDF. Ukuran maksimal 10MB per file.', icon: 'M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13' },
    { q: 'Cara mengisi tanggal kadaluarsa?', a: 'Isi sesuai tanggal yang tertera di sertifikat fisik kamu. Sistem akan otomatis menghitung status dan mengirim reminder sebelum tanggal tersebut.', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
    { q: 'Dokumen langsung aktif setelah diupload?', a: 'Tidak. Setelah upload, dokumen masuk status "Pending Approval" dan perlu diverifikasi admin HR terlebih dahulu sebelum menjadi Aktif.', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
]);
