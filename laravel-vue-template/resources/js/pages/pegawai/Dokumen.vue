...
useFaq([
    { q: 'Cara filter dokumen?', a: 'Gunakan filter di bagian atas — bisa filter berdasarkan status, kategori, jenis, atau rentang tanggal kadaluarsa. Semua filter berjalan otomatis tanpa reload.', icon: 'M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z' },
    { q: 'Cara export data ke Excel?', a: 'Klik tombol Export Excel di kanan atas. File akan otomatis terunduh berisi seluruh daftar dokumen kamu.', icon: 'M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
    { q: 'Apa arti status "Pending Approval"?', a: 'Dokumen sudah diupload dan sedang menunggu verifikasi dari admin HR. Kamu akan dapat notifikasi setelah dokumen disetujui atau ditolak.', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
]);
</script>
