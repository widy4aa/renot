...
useFaq([
    { q: 'Kapan sistem mengirim notifikasi?', a: 'Reminder otomatis dikirim pada H-60, H-45, H-30, H-14, H-7, dan H-1 sebelum tanggal kadaluarsa dokumen.', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
    { q: 'Cara menandai semua notifikasi dibaca?', a: 'Klik tombol "Tandai semua dibaca" di kanan atas halaman ini, atau buka dropdown notifikasi di topbar dan klik "Baca semua".', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
    { q: 'Apa saja jenis notifikasi yang ada?', a: 'Ada 4 jenis: Reminder (dokumen akan kadaluarsa), Expired (dokumen sudah kadaluarsa), Disetujui (dokumen diverifikasi admin), dan Ditolak (dokumen perlu diperbaiki).', icon: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9' },
]);
</script>
